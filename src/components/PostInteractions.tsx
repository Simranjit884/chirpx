...
const PostInteractions = ({
  ...
  return (
    <div className="my-2 flex items-center justify-between gap-4 text-textGray lg:gap-16">
      <div className="flex flex-1 items-center justify-between">
        ...
        >
          ...
          <span className="text-sm group-hover:text-iconBlue">{count.comments}</span>
        </Link>
        {/* REPOST */}
        ...
        <button className="group flex cursor-pointer items-center gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
            <path
              className={`${
                optimisticCount.isRePosted ? "fill-iconGreen" : "fill-textGray"
          ...
          <span
            ...
            } text-sm group-hover:text-iconGreen`}
          >
        ...
        <form action={likeAction}>
          <button className="group flex cursor-pointer items-center gap-2">
            ...
            <span
              ...
              } text-sm group-hover:text-iconPink`}
            >
