  ...
  return (
    <div className="flex h-screen items-center justify-between p-8">
      ...
      <div className="flex w-full flex-col gap-4 lg:w-1/2">
        <h1 className="text-2xl font-bold xsm:text-4xl md:text-6xl">Happening now</h1>
        <h1 className="text-2xl">Join today.</h1>
        <SignIn.Root>
          <Clerk.Connection
            name="google"
            className="flex w-72 items-center justify-center gap-2 rounded-full bg-white p-2 font-bold text-black"
          >
          ...
          <SignIn.Step name="start">
            <Clerk.Field name="identifier" className="flex flex-col gap-2">
              <Clerk.Input
                ...
                className="w-72 rounded-full px-6 py-2 text-black placeholder:text-sm"
              />
              <Clerk.FieldError className="text-sm text-red-300" />
            </Clerk.Field>
            <SignIn.Action submit className="mt-2 w-72 text-center text-sm text-iconBlue underline">
              Continue
            </SignIn.Action>
          </SignIn.Step>
          <SignIn.Step name="verifications">
            <SignIn.Strategy name="password">
              ...
              <div className="flex flex-col gap-2">
                <SignIn.Action
                  submit
                  className="mt-2 w-72 text-center text-sm text-iconBlue underline"
                >
                  Continue
                </SignIn.Action>
                <SignIn.Action
          ...
          <div className="flex w-72 items-center gap-4">
            <div className="h-px flex-grow bg-borderGray"></div>
            <span className="text-textGrayLight">or</span>
            <div className="h-px flex-grow bg-borderGray"></div>
          </div>
          <Link
            href="/sign-up"
            className="w-72 rounded-full bg-iconBlue p-2 text-center font-bold text-white"
          >
            Create Account
          </Link>
          <p className="w-72 text-xs">
            By signing up, you agree to the <span className="text-iconBlue">Terms of Service</span>{" "}
            and <span className="text-iconBlue">Privacy Policy</span>, including{" "}
